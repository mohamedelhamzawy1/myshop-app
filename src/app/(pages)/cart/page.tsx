...
export default function Cart() {
 ...
 Looks like you haven’t added anything yet.  
      Start shopping and fill your cart! </p>
          <Link href="/Products">
                  ...
                  <div className="flex flex-col items-end justify-between h-full gap-4">
                    <div className="flex items-center gap-2 border rounded px-2 py-1">
                      <Button
                        ...
                        disabled={updateId === item.product.id || item.count === 1}
                      >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-lg font-bold">
                        {(item.price ?? item.product.price)?.toLocaleString()} EGP
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border shadow-sm h-fit flex flex-col gap-6 sticky top-32">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>Subtotal</span>
                    <span>{cartData?.data?.totalCartPrice?.toLocaleString() ?? 0} EGP</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Delivery</span>
                    <span>50 EGP</span>
                ...
                <div className="flex justify-between text-lg font-bold">
                  <span>Total</span>
                  <span>{((cartData?.data?.totalCartPrice ?? 0) + 50).toLocaleString()} EGP</span>
                </div>
